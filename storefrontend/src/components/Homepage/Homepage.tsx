          ...
          <a href="#">
            <div className="flex justify-center items-center">
              <img
                ...
                src="https://cdn.dsmcdn.com/ty1162/product/media/images/prod/SPM/PIM/20240207/04/461eb0db-c697-3981-9703-0dc19a0e8dfe/1_org_zoom.jpg"
                alt="clothing image"
                width={225}
              />
            </div>
          ...
          <div className="px-5 pb-5">
            <a href="#">
              <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                {products.name} <br />
                <h1 className="text-xs font-semibold tracking-tight text-blue-900 dark:text-white">
